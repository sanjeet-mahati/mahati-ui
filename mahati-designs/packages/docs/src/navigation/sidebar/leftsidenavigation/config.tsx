...
export const NavItems = (): NavItem[]  => {
  ...
  subItems: [
   ...
   { name: 'searchable', href: '/nesteddropdown#searchable', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },
  { name: 'multiselect', href: '/nesteddropdown#multiselect', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },
  { name: 'cascading', href: '/nesteddropdown#cascading', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },
  { name: 'avatar', href: '/nesteddropdown#avatar', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },
  { name: 'avatarmultiselect', href:'/nesteddropdown#avatarmultiselect', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },
  { name: 'grouped', href: '/nesteddropdown#grouped', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },
  { name: 'async', href: '/nesteddropdown#async', icon: <FontAwesomeIcon icon={faChevronDown} size="sm" /> },

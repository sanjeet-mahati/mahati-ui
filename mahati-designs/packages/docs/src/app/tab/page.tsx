...
import {MTabbedInterface} from "@/components";
  ...
  return (
    <>
      ...
      >
        ...
        <DemoGrid>
          <MTabbedInterface tabs={tabArr} variant="outline" />
        </DemoGrid>
      </Section>
      ...
      >
        ...
        <DemoGrid>
          <MTabbedInterface tabs={tabArr} variant="dark" />
        </DemoGrid>
      </Section>
      ...
      >
        ...
        <DemoGrid>
          <MTabbedInterface tabs={tabArr} variant="underline" />
        </DemoGrid>
      </Section>
      ...
      >
        ...
        <DemoGrid>
          <MTabbedInterface tabs={tabArr} variant="shadow" />
        </DemoGrid>
      </Section>
      ...
      >
        ...
        <DemoGrid>
          <MTabbedInterface tabs={tabArr} variant="glass" />
        </DemoGrid>
      </Section>
      ...
      >
        ...
        <DemoGrid>
          <MTabbedInterface tabs={tabArr} variant="gradient" />
        </DemoGrid>
      </Section>
    </>
  );

...
//           </div>
//           <div className="input-float">
//             <input className="input" type="text" name={name} value={val} onChange={handleChange} placeholder=" " autoComplete={autoComplete} />
//             <label className="input-label">{label}</label>
//           </div>
//         </div>
//       </div>
...
//   <RadiusUtilStyles>
//     <input className={`input-base ${radiusClass}`} type="text" placeholder={placeholder} value={value} onChange={onChange} />
//   </RadiusUtilStyles>
// );
...
// const BGFormContainer = styled(FormContainer)<{ $bg: string; $opacity: number }>`
//   position: relative;
//   overflow: hidden;
//   isolation: isolate;
//   padding: 24px;
...
//               <input ref={fileInputRef} type="file" multiple style={{ display: 'none' }} onChange={onFilesChange} />
...
//       <Section id="avatarPlaceholderInput">
...
//         <FormContainer onSubmit={handleIconFormSubmit} style={{ padding: 24 }}>
//           <CompactFormArea>
...
const Page = () => {
  ...
  const [selectedRadius, setSelectedRadius] = useState<string>('rounded');
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4">
      {/* Page Header */}
      <div className="mb-12">
        <h1 className="text-5xl font-bold text-gray-900 mb-4">Form & Input Components</h1>
        <p className="text-xl text-gray-600 leading-relaxed max-w-3xl">
          A collection of flexible form components built with Tailwind CSS
        </p>
      </div>

      {/* Basic Inputs Section */}
      <section id="basic-inputs" className="mb-12 p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Basic Inputs</h2>
        <p className="text-gray-600 mb-6 leading-relaxed">
          Standard input components with various states and validations
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {/* Default Input */}
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            <input
              type="text"
              placeholder="Default input"
              className="w-[438px] max-w-full h-11 rounded-md border border-gray-300 px-4"
            />
          ...
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            <div className="w-full">
              <input
                ...
                className="w-[438px] max-w-full h-11 rounded-md border border-red-500 px-4"
              />
          ...
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            <input
              ...
              className="w-[438px] max-w-full h-11 rounded-md border border-green-500 px-4"
            />
      ...
      <section id="floating-inputs" className="mb-12 p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Floating Label Inputs</h2>
        <p className="text-gray-600 mb-6 leading-relaxed">
          Input components with animated floating labels
        </p>
          ...
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            <div className="relative w-full">
              <input
                type="text"
                id="floating-input"
                className="peer w-full h-11 px-4 pt-5 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                placeholder=" "
              />
              <label
                htmlFor="floating-input"
                className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:text-blue-600"
              >
                Email address
              </label>
            </div>
            <span className="text-sm text-gray-600">Basic floating label</span>
          </div>
          ...
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            <div className="relative w-full">
              ...
              <input
                type="text"
                id="icon-input"
                className="peer w-full h-11 pl-10 pt-5 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                placeholder=" "
              />
              <label
                htmlFor="icon-input"
                className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-10 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:text-blue-600"
              >
                Username
              </label>
            </div>
            <span className="text-sm text-gray-600">With leading icon</span>
          </div>
          ...
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            <div className="relative w-full">
              ...
              <input
                ...
                id="password-input"
                className="peer w-full h-11 pl-10 pr-10 pt-5 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                placeholder=" "
              />
              <button
                type="button"
            ...
            <span className="text-sm text-gray-600">With password toggle</span>
          </div>
        </div>
      </section>

      {/* File Upload Section */}
      <section id="file-upload" className="mb-12 p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">File Upload</h2>
        <p className="text-gray-600 mb-6 leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          <div className="p-6 border border-gray-200 rounded-lg bg-gray-50 flex flex-col gap-4 items-center">
            ...
            <span className="text-sm text-gray-600">Basic file upload</span>
          </div>
        </div>
      </section>

      {/* Form Example */}
      <section id="form-example" className="mb-12 p-8 bg-white rounded-xl border border-gray-200 shadow-sm">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Complete Form Example</h2>
        <p className="text-gray-600 mb-6 leading-relaxed">
          A complete form implementation showcasing various input types
        </p>
          ...
          <div className="space-y-6">
            <div className="relative">
              <input
                ...
                placeholder=" "
              />
              <label className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:text-blue-600">
                Username
              </label>
            </div>

  ...
  return (
    <div style={pageStyle}>
      <div style={containerStyle}>
        ...
        <p style={subtitleStyle}>Customizable toast notifications with TypeScript and Plain CSS</p>
        ...
        <div style={gridStyle}>
          ...
          {/* Error */}
          <section style={sectionStyle}>
            <h2 style={sectionTitleStyle}>Error Toast Type</h2>
            <div style={toastTypeColumnStyle}>
              <button
          ...
          {/* Warning */}
          <section style={sectionStyle}>
            <h2 style={sectionTitleStyle}>Warning Toast Type</h2>
            <div style={toastTypeColumnStyle}>
              <button
          ...
          {/* Info */}
          <section style={sectionStyle}>
            <h2 style={sectionTitleStyle}>Information Toast Type</h2>
            <div style={toastTypeColumnStyle}>
              <button
          ...
          {/* Liquid UI */}
          <section style={sectionStyle}>
            <h2 style={sectionTitleStyle}>Liquid UI Toast Type</h2>
            <div style={toastTypeColumnStyle}>
              <button
                onClick={() => addToast('liquidUI', 'Liquid UI!', 'You are seeing sample Liquid UI toast.')}
                style={{ ...getToastButtonStyle('rgba(178,185,182,0.4)', 'black'), textAlign: 'center' }}
                onMouseEnter={(e) => (e.currentTarget.style.opacity = '0.9')}
                onMouseLeave={(e) => (e.currentTarget.style.opacity = '1')}
              >
          ...
          <section style={sectionStyle}>
            ...
            <button
              ...
              style={{ ...getToastButtonStyle('rgba(139,92,246,1)'), width: '100%', maxWidth: '448px' }}
              onMouseEnter={(e) => (e.currentTarget.style.opacity = '0.9')}
              onMouseLeave={(e) => (e.currentTarget.style.opacity = '1')}
            >
          ...
          <section style={sectionStyle}>
            ...
            <div style={durationGridStyle}>
              <button
                ...
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = 'rgba(229,231,235,1)')}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'rgba(243,244,246,1)')}
              >
                2 seconds
              </button>
              <button
          ...
          <section style={sectionStyle}>
            ...
            <div style={actionsWrapperStyle}>
              ...
              <div style={toastCountStyle}>Active Toasts: {toasts.length}</div>
            </div>
          </section>
        </div>
      </div>

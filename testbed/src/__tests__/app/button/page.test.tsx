...
describe("ButtonPage", () => {
  ...
  it("renders all CodePreview sections", () => {
    ...
    expect(titles).toEqual([
      ...
      "Icon Buttons - Custom Hover Colors (Please Move The Cursor On The Icon Buttons To See The Custom Hover Effect)",
      "Icon Buttons - Intensity Levels (Please Move The Cursor On The Icon Buttons To Check The Intensity Levels)",
      "Icon Buttons - Different Background Padding (This is padding Effect When we Increase The Padding The width of Padding Increases)",

...
// Props for MahatiConfettiExplosion component
const MahatiConfettiExplosionProps = [
  {
    name: "particleCount",
    type: "number",
    default: "200",
...
// Props for MahatiRealisticConfetti component
const MahatiRealisticConfettiProps = [
  {
    name: "particleCount",
    type: "number",
    default: "150",
...
export default function TooltipDemo() {
  return (
    <div className="w-full max-w-6xl mx-auto p-6">
      ...
      {/* MahatiConfettiExplosion Props Table */}
      <div className="mb-12">
        
        <PropsTable props={MahatiConfettiExplosionProps} title="MahatiConfettiExplosion Props" />
      </div>

      {/* MahatiRealisticConfetti Props Table */}
      <div className="mb-12">
        
        <PropsTable props={MahatiRealisticConfettiProps} title="MahatiRealisticConfetti Props" />
      </div>
...
<div className="flex flex-col gap-2">
  ...
  <div className="relative">
    ...
    <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
      ...
      <CodePreview
        title="Celebration"
        description="Tooltips with built-in animation support using MahatiConfettiExplosion and MahatiRealisticConfetti components."
        code={`import MahatiTooltip from "@/components/TooltipTailwindCSS";
import MahatiConfettiExplosion from "@/components/MahatiConfettiExplosion";
import MahatiRealisticConfetti from "@/components/MahatiRealisticConfetti";

// Birthday celebration with MahatiConfettiExplosion
<MahatiTooltip 
  text="🎂 Happy Birthday! Let's celebrate!"
  position="top"
  animation={{
    component: MahatiConfettiExplosion,
    props: {
      particleCount: 250,
...
// Congratulations with MahatiRealisticConfetti
<MahatiTooltip 
  text="🥳 Congratulations! Let's have a party!"
  position="top"
  animation={{
    component: MahatiRealisticConfetti,
    props: {
      particleCount: 400,
